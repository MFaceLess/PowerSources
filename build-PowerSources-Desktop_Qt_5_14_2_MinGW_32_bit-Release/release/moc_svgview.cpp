...
#include <memory>
#include "../../PowerSources/svgview.h"
...
QT_MOC_LITERAL(5, 36, 9) // "resetZoom"

    },
    "SvgView\0zoomChanged\0\0zoomIn\0zoomOut\0"
    "resetZoom"
};
...
void SvgView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SvgView::zoomChanged)) {
                *result = 0;
                return;
            }
        }
